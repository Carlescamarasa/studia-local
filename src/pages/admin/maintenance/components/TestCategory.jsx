 ...
 */
export default function TestCategory({ title, tests, results, onRunSingle, isRunning }) {
                ...
                <div className="border-t border-[var(--color-border-default)] bg-[var(--color-surface-muted)]/30">
                    <div className="p-4 space-y-2">
                        {tests.map((test) => {
                            ...
                            const hasEvidence = result?.evidence && (result.evidence.items?.length > 0 || result.evidence.summary);
