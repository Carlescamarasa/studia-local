  ...
  useEffect(() => {
    if (ejercicio) {
      ...
      setFormData({
        ...
        variations: (ejercicio.content?.variations?.length > 0 ? ejercicio.content.variations : (ejercicio.variations || [])).map(v => ({ ...v, id: v.id || generateUUID() })),
