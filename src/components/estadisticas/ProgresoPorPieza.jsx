 ...
 * 
 * @param {Object} props
 * @param {Array} props.progresoPorPieza - Array de { piezaNombre, tiempoTotal, sesiones, calificacionPromedio, ratioCompletado }
 */
export default function ProgresoPorPieza({ progresoPorPieza }) {
