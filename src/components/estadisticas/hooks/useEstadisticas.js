 ...
 */
function validarDuracion(duracionSeg) {
 ...
 */
function calcularRacha(registros, userIdActual) {
  ...
  const diasArraySortedAsc = Array.from(diasSet).sort();
 ...
 */
function calcularSemanasDistintas(registrosFiltrados) {
 ...
 */
function calcularCalidadPromedio(registrosFiltrados) {
