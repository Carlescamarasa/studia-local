 ...
 * 
 * @param {Object} props
 * @param {string|number} props.value - Valor a mostrar (se valida para evitar NaN)
 ...
 * @param {string} props.variant - Variante visual: 'default' | 'primary' | 'success' | 'warning' | 'danger'
 * @param {string} props.size - Tamaño: 'sm' | 'md' | 'lg'
 * @param {string|React.ReactNode} props.suffix - Sufijo opcional (ej: "min", "/4")
 * @param {string|React.ReactNode} props.prefix - Prefijo opcional (ej: "⭐")
