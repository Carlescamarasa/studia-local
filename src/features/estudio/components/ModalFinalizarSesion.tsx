...
interface ModalFinalizarSesionProps {
    /** Callback al confirmar con datos del formulario */
    onConfirmar: (payload: FinalizarSesionPayload) => void;
    /** Callback al cancelar */
    onCancelar: () => void;
}

export default function ModalFinalizarSesion({ onConfirmar, onCancelar }: ModalFinalizarSesionProps) {
